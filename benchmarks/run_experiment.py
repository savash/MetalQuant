...
This is the single benchmark entry point for baseline and compressed
cache backends. Results are written in a shared JSON format so they can
be compared directly with compare_results.py.
